...
export const clearInput = ({ nameInputElement, commentInputElement }) => {
...
export const addFormActive = ({ addForm, deleteButtonElement }) => {
  addForm.classList.remove("hide");
  // deleteButtonElement.classList.remove("hide");
};

export const addFormHide = ({ addForm, deleteButtonElement }) => {
